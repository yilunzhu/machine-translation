...
if __name__ == "__main__":
    ...
    # SimpleRNN
    model.add(SimpleRNN(rnn_dim, activation='sigmoid', return_sequences=True))

    # LSTM
    # model.add(LSTM(rnn_dim, activation="sigmoid", return_sequences=True))

    # bidirectional LSTM
    # model.add(Bidirectional(LSTM(rnn_dim, activation="sigmoid", return_sequences=True)))
